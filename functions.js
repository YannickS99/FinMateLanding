...
const translations = {
    en: {
        ...
        "hero.subtitle": "Track your expenses, set savings goals, and get insights into your financial health with FinMate.",
        ...
        "features.f4.desc": "Set savings goals – FinMate automatically calculates your monthly potential and progress.",
        ...
        "features.f6.desc": "Sync your data across all devices via the cloud. iPhone, iPad – always up to date.",
        ...
        "download.desc": "FinMate will be available soon in the App Store.",
    ...
    de: {
        ...
        "hero.subtitle": "Verfolge deine Ausgaben, setze Sparziele und erhalte Einblicke in deine finanzielle Gesundheit mit FinMate.",
        "cta.main": "Demnächst",
        ...
        "features.f4.desc": "Setze Sparziele – FinMate berechnet automatisch dein monatliches Potenzial und den Fortschritt.",
        ...
        "features.f6.title": "Cloud-Sync",
        "features.f6.desc": "Synchronisiere deine Daten sicher über die Cloud auf all deinen Geräten wie iPhone und iPad.",
        ...
        "download.desc": "FinMate wird in Kürze im App Store erhältlich sein.",
